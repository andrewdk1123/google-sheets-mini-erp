...
// Test cases for the createRecordWithKey function
function testCreateRecordWithKey() {
    // Test case 1: Insert a new record with a key and values
    const workbookId = 'your_workbook_id';
    const insertRange = 'Sheet1!A2:G';
    const valueArray = ['Value1', 'Value2', 'Value3', 'Value4', 'Value5', 'Value6'];
  
    console.log('Test case 1:');
    console.log('Inserting a new record with a key and values...');
    createRecordWithKey(workbookId, insertRange, valueArray);
  
    // Test case 2: Insert a new record with an empty value array
    const emptyValueArray = [];
  
    console.log('Test case 2:');
    console.log('Inserting a new record with an empty value array...');
    createRecordWithKey(workbookId, insertRange, emptyValueArray);
